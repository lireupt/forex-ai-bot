    ...
    result = {
        ...
        "gate_diagnostics": {
            ...
            "config": {
                ...
                "block_near_high_impact_events": config["block_near_high_impact_events"],
                "block_extreme_news_risk": config["block_extreme_news_risk"],
                "event_block_window_minutes": config["event_block_window_minutes"],
